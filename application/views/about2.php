            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <a href="<?php echo site_url('Mypage/index');?>" class="nav-item nav-link  ">Home</a>
                        <a href="<?php echo site_url('Mypage/link1');?>" class="nav-item nav-link active ">About</a>
                    ...
                    <div class="col-md-6">
                        <div class="about-img">
                            <div class="about-img-1">
                                <img src="<?php echo base_url('img');?>/som-3.JPEG">        
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="section-header">
                            <h2>Piyawan Tathip</h2>
                            <h4>Rajamangala University of Technology Lanna Tak</h4>
                            <h4>- Information Technology -</h4>
                            <p> GPA : 3.15 </p>
                            <br><br>
                            <p> ชื่อเล่น : ส้มโอ </p>
                            <p> วันเกิด : 23 พฤศจิกายน 2543 </p>
                            <p> อายุ : 20 </p>
                        </div>
                    </div>
                </div>
