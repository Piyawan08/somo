            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav m-auto">
                        ...
                        <a href="<?php echo site_url('Mypage/link4');?>" class="nav-item nav-link active">Contact</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-8">
                        <div class="contact-info">
                            ...
                            <div class="contact-text">
                                <h3>ที่อยู่</h3>
                                <p>77/12 ถ.มหาดไทยบำรุง ต.หนองหลวง อ.เมือง จ.ตาก 63000</p>
                            </div>
                        </div>
                        <div class="contact-info">
                            <div class="contact-icon">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="contact-text">
                                <h3>Piyawan Cr</h3>
                                <a href="https://www.facebook.com/piyawan23s">ลิงค์</a>
                            </div>
                        </div>
                    </div>
